...
if __name__ == '__main__':
    ...
    plt.title("Overlap Energy vs x of the center cell (Area^2)")
    ...
    plt.title("Overlap Energy vs x of the center cell (Area^2 - ZOOM)")
    ...
    plt.title("Total Overlap Energy vs x of the center cell (Area^2 - ZOOM)")
    ...
    plt.plot((y - 7.5 + eps*np.arange(2000))[920:1080], one_energy_vals[920:1080])  
    plt.title("Overlap Energy vs y of the center cell (Area^2 - ZOOM)")
    plt.savefig("check/one_energy_center_y_area_sqr_zoom.png")
    plt.close() 

    plt.plot((y - 7.5 + eps*np.arange(2000))[920:1080], total_energy_vals[920:1080])    
    ...
    plt.plot((th - np.pi + eps*np.arange(2000))[800:1200], one_energy_vals[800:1200])  
    ...
    plt.plot((th - np.pi + eps*np.arange(2000))[800:1200], total_energy_vals[800:1200])  
